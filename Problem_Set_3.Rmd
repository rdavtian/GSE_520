...
>**Solution:**  
>```{r}
# Tried creating b1, b2, ..., etc. separately using cov(x,y) / var(x) but wasn't getting the correct beta coefficients. We created a covariance matrix of predictors and a covariance matrix of the prdictors with the response variable and solved the matrix equation Ax = b to get the beta coefficients (b1, b2, ...)
