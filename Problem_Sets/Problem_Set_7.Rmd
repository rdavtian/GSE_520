...
var_b1 = variance*n*var(x1_sample_var)
var_b2 = variance*n*var(x2_sample_var)
cov_b1_b2 = variance*n*cov(x1_sample_var, x2_sample_var)
cov_b2_b1 = variance*n*cov(x1_sample_var, x2_sample_var)
cat(" Var(b1):", var_b1, "\n",
    "Var(b2): ",var_b2, "\n", "\n",
    "Cov(b1,b2):", cov_b1_b2, "\n",
    "Cov(b2,b1)", cov_b2_b1)
