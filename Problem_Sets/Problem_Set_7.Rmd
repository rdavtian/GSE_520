...
var_b
```
> Increasing sample size from 50 to 1000 results in the  variance-covariance matrix of b to decrease of which is what we expected. 
...
>**Solution:**
>```{r}
print(plot(density(beta_1_est)))
print(plot(density(beta_2_est)))
```
> Yes, the estimates for $b_1$ and $b_2$ appear to be normally distributed. 
