...
R^2 = & 1 - \frac{Y - \hat Y}{Y - \bar Y}\\
\end{align*}

>Also from part b, $\widehat Y$ = $\widehat Y^{*}$ is equal to $P_xY$ = $P_xY$. Therefore,
\begin{align*}
1 - \frac{Y - \hat Y}{Y - \bar Y} = & 1 - \frac{Y - \hat Y^{*}}{Y - \bar Y}\\
1 - \frac{XB + \varepsilon - Xb}{XB + \varepsilon - \bar Y} = & 1 - \frac{XB + \varepsilon - Xb^{*}}{XB + \varepsilon - \bar Y}
\end{align*}
