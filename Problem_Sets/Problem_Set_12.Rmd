...
linearHypothesis(mod1, c("UonlyTRUE=UHTRUE"))
linearHypothesis(mod1, "HonlyTRUE=UHTRUE")
linearHypothesis(mod1, "UonlyTRUE=HonlyTRUE")
linearHypothesis(mod1, "UHTRUE = UonlyTRUE + HonlyTRUE")
```
...
linearHypothesis(mod2, c("UonlyTRUE=UHTRUE"))
linearHypothesis(mod2, "HonlyTRUE=UHTRUE")
linearHypothesis(mod2, "UonlyTRUE=HonlyTRUE")
linearHypothesis(mod2, "UHTRUE = UonlyTRUE + HonlyTRUE")
```
