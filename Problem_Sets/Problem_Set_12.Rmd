...
#linearHypothesis(mod1,c("Uonly=UH","Honly=UH","Uonly=Honly","UH = Uonly + #Honly"),vcov=ClusV)
```
...
#linearHypothesis(mod2,c("Uonly=UH","Honly=UH","Uonly=Honly","UH = Uonly + #Honly"),vcov=ClusV)
```
